...
i3 = i3ipc.Connection(socket_path=os.environ['SWAYSOCK'])

# Print the name of the focused window
__import__('pdb').set_trace()
focused = i3.get_tree().find_focused()
focused_workspace = focused.workspace().name
print(f'Focused window {focused.name} is on workspace {focused_workspace}')
...
#     # The first parameter is the connection to the ipc and the second is
#     # an object
